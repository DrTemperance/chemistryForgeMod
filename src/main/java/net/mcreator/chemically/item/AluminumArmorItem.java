...
public abstract class AluminumArmorItem extends ArmorItem {
	public AluminumArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(ChemicallyModItems.ALUMINUM_INGOT.get()));
			}
	...
	public static class Helmet extends AluminumArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "chemically:textures/models/armor/aluminum_layer_1.png";
		}
	...
	public static class Leggings extends AluminumArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "chemically:textures/models/armor/aluminum_layer_2.png";
		}

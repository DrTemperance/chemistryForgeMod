...
public class HydraulicPressBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public HydraulicPressBlockEntity(BlockPos position, BlockState state) {
		super(ChemicallyModBlockEntities.HYDRAULIC_PRESS.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("hydraulic_press");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Hydraulic Press");
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(500000, 500, 500, 0) {
		@Override
